...
_import_structure = {
    ...
    "length_rewards": ["get_soft_overlong_punishment", "get_accuracy_conditioned_length_reward"],
...
if TYPE_CHECKING:
    ...
    from .length_rewards import get_soft_overlong_punishment, get_accuracy_conditioned_length_reward
